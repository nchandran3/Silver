...
public class RaceSelectPanel extends Screen
{
	...
	private HashMap<String, ImageIcon> map = new HashMap<>(); // allows calling
																// images by
																// their name
	...
	/**
	 * This creates the panel where the races will be displayed on the create
	 * player class and reads what the user presses and sets that player's race
	...
	private class ButtonListener implements ActionListener, Serializable
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			changePicture(src); // changes the central image to the selected
								// race
		}
