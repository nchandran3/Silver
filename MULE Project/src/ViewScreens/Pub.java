...
import Game.*;
/**
 * The Gamble class just calculates the amount of money each player gets after their turn based on how
 * much time remains in the game clock for their turn. 
 * 
 * @author Andrew Ford
 *
 */
public class Pub{
	...
	/**
	 * Gets the time left on the game clock and adds the corresponding amount to the players total amount
	 * of gold based on the time left.
	 * 
	 * @param time
	 */
	...
	/**
	 * Calculates the round bonus based on the current round because based on your round it is important to
	 * get more money later on in the game based on how the game changes and the players need more money.
	 * 
