 ...
 * @param percentX the percent x of the panel to center the component
 ...
 */
	 ...
	 * Overload
	 * Sets the bounds of the component by computing the percent of pixels horizontally and vertically. Centers the component on the given pixel.
	 * Scales the component based on the given width and height ratios
	 * @param component the JComponent to add to the panel 
	 * @param percentX the percent x of the panel to center the component
	 * @param percentY the percent y of the panel to center the component 
	 * @param rwidth the ratio to scale the width
	 ...
	 * @param icon the ImageIcon to compress
	...
	{
		Image icon2 = icon.getImage().getScaledInstance(width, height, Image.SCALE_FAST);
		return new ImageIcon(icon2);
	}
	
	/**
	 * Overload
	 * Creates a compressed ImageIcon from a file in the working directory
	...
	{
		Image icon2 = new ImageIcon(image).getImage().getScaledInstance(width, height, Image.SCALE_FAST);
		return new ImageIcon(icon2);
	} 
